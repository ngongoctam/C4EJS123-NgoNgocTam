// BÀI 1
// Bài 1.1: Các giá trị của x là name rice brand color. Đây là thuộc tính
// Bài 1.2
let product = {
...
//Bài 3.1: Kiểu dữ liệu lớp ngoài cùng là Object
//Bài 3.2: Thuộc tính hints là Array
//Bài 3.3: 
...
//Bài 4.1
while (true) {
    alert('Xin chào, đây là từ điển thông minh');
    let key = prompt('Hãy nhập vào keyword');
    if (key == 'debug') {
        alert(`${key}\n${dic.debug}`);
    } else if (key == 'done') {
        alert(`${key}\n${dic.done}`);
        ...
        alert(`Sorry, chúng tôi không tìm thấy ${key} trong từ điển`);
        break;
    }
}
//Bài 4.2
while (true) {
    ...
    if (key == 'debug') {
        ...
        let exp = prompt(`Sorry, chúng tôi không tìm thấy "${key}" trong từ điển.\nBạn có thể định nghĩa "${key}" ở ô bên dưới`);
        alert('Xong');
        dic[`${key}`]= exp;
        console.log(dic);

        key = prompt('Hãy nhập vào keyword vừa định nghĩa');
            alert(`${key}\n${exp}`);           
        break;
    }
}
...
let viTri = Number(prompt('Hãy nhập vị trí sản phẩm'));
let i = viTri - 1;
console.log(`Name: ${product[i].name}`);
...
// Bài 5.3:
let danhMuc = prompt('Hãy nhập vào danh mục');
for (let i = 0; i < product.length; i++) {
    if (product[i].category == danhMuc) {
        console.log('--------------------------------------');
        console.log(`Name: ${product[i].name}`);
        console.log(`Price: ${product[i].price}`);
    }
...
// Bài 5.5
let nhaCungcap = prompt('Nhập nhà cung cấp');
console.clear();
for (i = 0; i < product.length; i++) {
    for (j = 0; j < product[i].providers.length; j++) {
        if (product[i].providers[j] == nhaCungcap) {
            console.log('--------------------------------------');
            console.log(`Name: ${product[i].name}`);
            console.log(`Brand: ${product[i].brand}`);
            console.log(`Price: ${product[i].price}`);
...
console.log('Xin chào, dưới đây là những nhiệm vụ cần học để trở thành Lập trình viên');
for (i = 0; i < dev.length; i++) {
    console.log(`${i+1}. ${dev[i].task}`);
    console.log(`   Complete: ${dev[i].process}`);
}
// Bài 6.2
let thaoTac = prompt('Nhập thao tác (new, delete, update, complete');
if (thaoTac == 'new') {
    let newTask = prompt('Nhập nhiệm vụ học tập mới');
    dev.push({task: newTask, process: false});
}
console.clear();
for (i = 0; i < dev.length; i++) {
    console.log(`${i+1}. ${dev[i].task}`);
...
let thaoTac = prompt('Nhập thao tác (new, delete, update, complete');
if (thaoTac == 'update') {
    let viTri = Number(prompt('Vị trí nhiệm vụ cần update'));
    let newTask = prompt('Nhập nhiệm vụ học tập mới');
    dev[viTri-1].task = newTask;
    console.log(dev);
...
let thaoTac = prompt('Nhập thao tác (new, delete, update, complete');
if (thaoTac == 'complete') {
    let viTri = Number(prompt('Vị trí nhiệm vụ cần hoàn thành'));
    dev[viTri-1].process = true;
}
console.clear();
for (i = 0; i < dev.length; i++) {
    console.log(`${i+1}. ${dev[i].task}`);
...
let thaoTac = prompt('Nhập thao tác (new, delete, update, complete');
if (thaoTac == 'delete') {
    let viTri = Number(prompt('Vị trí nhiệm vụ cần xóa'));
    dev.splice(viTri-1, 1);
}
console.clear();
for (i = 0; i < dev.length; i++) {
    console.log(`${i+1}. ${dev[i].task}`);
...
//BÀI 13:
// Raw: https://uphinh.vn/image/tYZtKa
// Parsed: https://uphinh.vn/image/tYZU05

// BÀI 14: https://uphinh.vn/image/tYZaBh
...
// Bài 15.6
for (i = 0; i < jobData.hits.length; i++) {
    console.log(jobData.hits[i].jobTitle);
    console.log('Benefits');
    for (j = 0; j < jobData.hits[i].benefits.length; j++) {
...
for (i = 0; i < jobData.hits.length; i++) {
    ...
    console.log('Skills:');
    for (k = 0; k < jobData.hits[i].skills.length; k++) {
...
let oldData = {
    ...
    pho: {
        price: 35,
        vnName: 'Phở bò tái nạm'
    },
    };
let {noddle, ...rest} = oldData;
